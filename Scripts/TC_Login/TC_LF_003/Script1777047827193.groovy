...
WebUI.setEncryptedText(findTestObject('TC_Login/Page_Ingresar  Office Depot Mexico/input__Contrasea'), 'dopgMZS9m+09JXg4SNc9zA==')

WebUI.click(findTestObject('TC_Login/Page_Ingresar  Office Depot Mexico/button_loginButtonMaterial'))

WebUI.verifyElementPresent(findTestObject('TC_Login/Page_Ingresar  Office Depot Mexico/span_j_password.errors'), 0)
