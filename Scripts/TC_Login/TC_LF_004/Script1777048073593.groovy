...
WebUI.verifyElementPresent(findTestObject('TC_Login/Page_Ingresar  Office Depot Mexico/div_Este campo es obligatorio'), 
    0)

WebUI.verifyElementPresent(findTestObject('TC_Login/Page_Ingresar  Office Depot Mexico/div_Este campo es obligatorio_1'), 
    0)
