...
WebUI.setText(findTestObject('TC_Login/Page_Ingresar  Office Depot Mexico/input__Correo electrnico'), 'skthakur@kognivera.')

WebUI.setEncryptedText(findTestObject('TC_Login/Page_Ingresar  Office Depot Mexico/input__Contrasea'), 'dopgMZS9m+2HSvTCorbjBA==')

WebUI.click(findTestObject('TC_Login/Page_Ingresar  Office Depot Mexico/span_view-password'))

WebUI.click(findTestObject('TC_Login/Page_Ingresar  Office Depot Mexico/button_loginButtonMaterial'))

WebUI.verifyElementPresent(findTestObject('TC_Login/Page_Ingresar  Office Depot Mexico/div_Por favor ingresa un correo vlido'), 
    0)
