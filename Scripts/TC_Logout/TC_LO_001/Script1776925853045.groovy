...
WebUI.click(findTestObject('TC_Logout/Page_Office Depot Mexico  Compra en lnea Ar_97767d/div_Hola'))

WebUI.mouseOver(findTestObject('TC_Logout/Page_Office Depot Mexico  Compra en lnea Ar_97767d/label_Hola'))

WebUI.click(findTestObject('TC_Logout/Page_Office Depot Mexico  Compra en lnea Ar_97767d/span_Salir'))

WebUI.verifyElementPresent(findTestObject('TC_Logout/Page_Office Depot Mexico  Compra en lnea Ar_97767d/div_Inicia'), 0)
